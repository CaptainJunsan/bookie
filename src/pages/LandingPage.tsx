...
import { BookOpen, Users, Star, Share2, TrendingUp, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 max-w-md">
              ...
              rate stories, and celebrate every page turned.
            </p>
      ...
      <section className="py-20 px-5 max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">One cosy spot for every book your family ever reads, from picture books to chapter books.</p>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            { icon: <BookOpen size={24} />, emoji: "📖", title: "Log every book", desc: "Scan the ISBN with your camera, fetch the cover automatically, or add details by hand. Takes 30 seconds." },
            { icon: <TrendingUp size={24} />, emoji: "🔖", title: "Shared bookmarks", desc: "Each reader has their own coloured bookmark. See at a glance where Timmy, Sarah, and Mum are in the same book." },
            { icon: <Star size={24} />, emoji: "⭐", title: "Ratings & reviews", desc: "A parent recommendation rating and a reader's own joy rating. Short optional reviews make memories last." },
            { icon: <Users size={24} />, emoji: "👨‍👩‍👧‍👦", title: "Whole family, one app", desc: "Create profiles for each child — no logins needed for little ones. Invite partners and grandparents too." },
            { icon: <Share2 size={24} />, emoji: "💬", title: "Share the love", desc: "One tap to share a book with a friend over WhatsApp. Include the cover and rating in one beautiful message." },
            { icon: <TrendingUp size={24} />, emoji: "🏆", title: "Reading stats", desc: "Celebrate your best reader, track pages devoured, and see everyone's favourites on the family dashboard." },
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              ...
              { step: "3", emoji: "🎉", title: "Read & celebrate", desc: "Track progress, rate books, and share your favourites." },
      ...
      <footer className="border-t border-border py-8 px-5 text-center text-sm text-muted-foreground">
        ...
        <p>Made with ❤️ for families who love to read</p>
      </footer>
